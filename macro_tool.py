...
def render_image_search(
    ...
    def emit_opencv_search(region_vars, indent=""):
        ...
        lines.append(
            f'{indent}VisionPayload .= "],""threshold"":" . OpenCvThreshold . ",""profile"":""" . OpenCvProfile . """,""timeout"":" . OpenCvTimeout . ",""poll"":" . OpenCvPoll . ",""capture_cache_ms"":{capture_cache_ms},""capture_context"":""" . VisionContextJson . """}}"'
        )
